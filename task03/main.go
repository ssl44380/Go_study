...
func task_03_3_1(db *gorm.DB) {
	...
	var postList = []model.Post{
		{ID: 1, Title: "张三go 学习笔记", Context: "我是张三，go这个语言太难了..........", UserID: 1},
		{ID: 2, Title: "张三python 学习笔记", Context: "我是张三，python这个语言太简单了..........", UserID: 1},
		{ID: 3, Title: "李四go 学习笔记", Context: "我是李四，张三说的对，go这个语言太难了..........", UserID: 2},
		{ID: 4, Title: "李四python 学习笔记", Context: "我是李四，张三说的对，python这个语言太简单了..........", UserID: 2},
		{ID: 5, Title: "王五go 学习笔记", Context: "我是王五，他们说的都不对，go这个语言太简单了..........", UserID: 3},
		{ID: 6, Title: "王五python 学习笔记", Context: "我是李四，他们说的都不对，python这个语言才是真的难..........", UserID: 3},
	}
	global.CreateDate(db, postList)
	var commentList = []model.Comment{
		{ID: 1, Context: "这个作者说的对。", PostID: 1},
		{ID: 7, Context: "乱七八糟。", PostID: 1},
		{ID: 2, Context: "没有比python更简单的语言了", PostID: 2},
		{ID: 8, Context: "没有一点价值", PostID: 2},
		{ID: 3, Context: "你真的是在胡说八道", PostID: 3},
		{ID: 4, Context: "可以求一个教程吗", PostID: 4},
		{ID: 9, Context: "有一份教程吗？", PostID: 3},
		{ID: 5, Context: "一看作者就是大佬", PostID: 5},
		{ID: 10, Context: "我并不赞同这个说法", PostID: 5},
		{ID: 6, Context: "小白到底应该怎么学", PostID: 6},
	}
	global.CreateDate(db, commentList)
	db.Create(&model.User{ID: 4, Name: "肖七", Email: "xiaoqi@qq.com", Posts: []model.Post{
		{Title: "厨艺大全", Context: "番茄炒鸡蛋的做法是......"},
		{Title: "厨艺大全2", Context: "升级版番茄炒鸡蛋的做法是......"},
	}})
	var user1 = model.User{ID: 5, Name: "陈九", Email: "chenjiu@qq.com"}
	db.Create(&user1)
	post1 := model.Post{ID: 9, Title: "酿酒大全", Context: "桂花酒的制作工艺为......"}
	...
	*/
	...
	db.Model(&model.User{}).Select("id", "name").Where("name = ?", "李四").
		Preload("Posts", func(db *gorm.DB) *gorm.DB {
			return db.Select("id", "title", "Context", "user_id")
		}).Preload("Posts.Comments", func(db *gorm.DB) *gorm.DB {
		return db.Select("context", "post_id")
	}).First(&rawUser)
	...
	db.Model(&model.Post{}).Select("id", "Title", "Context", "user_id").
